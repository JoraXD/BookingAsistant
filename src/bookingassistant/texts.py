...
BOOKING_CANCELLED_MESSAGE = 'Бронирование отменено. Если захотите, можем попробовать ещё раз!'
...
MANAGER_PRICE_USER_TEMPLATE = 'Стоимость вашей заявки №{trip_id}: {price}. Оплатите по реквизитам: {details}'
